module.exports = async function(req, res) {
    ...
    const object = JSON.parse(JSON.stringify(cleanedUser))
    ...
    //to see the 500 status code handling (I'm just sending the user to their profile when the code comes in)
    if (req.wantsJSON) {
