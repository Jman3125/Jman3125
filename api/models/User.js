...
module.exports = {
  ...
  attributes: {
    ...
    details: {
      type: 'string',
      description: 'The details about the bands show',
      example: 'We are a high energy 80s band '
    },

    location: {
      type: 'string',
      description: 'State that the band is located in'
    },

    musicType: {
      type: 'string',
      description: 'The type of music the band plays'
    },

    musicAmount: {
      type: 'string',
      description: 'The amount of music that the band can play'
    },

    moneyShow: {
      type: 'string',
      description: 'How much money the band charges per show'
    },

    links: {
      type: 'string',
      description: 'Links to the bands social media account',
      defaultsTo: ''
    },

    phone: {
      type: 'string',
      description: 'Phone number for contacting band',
      defaultsTo: ''
    },
    //  ╔═╗╦═╗╦╔╦╗╦╔╦╗╦╦  ╦╔═╗╔═╗
    //  ╠═╝╠╦╝║║║║║ ║ ║╚╗╔╝║╣ ╚═╗
